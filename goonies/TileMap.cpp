...
bool TileMap::collisionSimpleMoveLeft(const glm::ivec2& pos, const glm::ivec2& size) const
{
	int x, y0, y1;
...
bool TileMap::collisionSimpleMoveRight(const glm::ivec2& pos, const glm::ivec2& size) const
{
	int x, y0, y1;
